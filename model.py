...
# input_data="Short levy of clinical fees from Dr. Ambedakar College Bangalore for the year 02-03 to 03-04 Rs. 28.29 lakh. (case pending in court)"
...
print(f'Your data belongs to category {prediction[0]}')
